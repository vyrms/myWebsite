...
export default function Contact ({ settings }) {
  ...
  return (
    <>
      <Head>
        <title>Contact - Hosei Nakajima</title>
      </Head>
        ...
        <div className="grid my-10 md:grid-cols-2">
          <div className="mb-3">
            ...
            <p className="max-w-sm my-5">
              Please reach out to me via <b>email</b>, <b>phone</b>, or the <b>contact form</b> on the right!
            </p>
            {/* <div className="mt-1 flex">
              ...
              <span>2461 Hunters Run Dr., Plano, TX 75025</span>
            </div> */}
            <div className="mt-1 flex">
              <svg className="w-4 h-4 mt-1 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
